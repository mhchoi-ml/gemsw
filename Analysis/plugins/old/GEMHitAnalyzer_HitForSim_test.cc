#ifndef GEMHitAnalyzer_HitForSim_test_H
#define GEMHitAnalyzer_HitForSim_test_H
...
class GEMHitAnalyzer_HitForSim_test : public edm::one::EDAnalyzer<edm::one::WatchRuns> {  
public:
  explicit GEMHitAnalyzer_HitForSim_test(const edm::ParameterSet&);
  ~GEMHitAnalyzer_HitForSim_test();
...
GEMHitAnalyzer_HitForSim_test::GEMHitAnalyzer_HitForSim_test(const edm::ParameterSet& iConfig)
...
GEMHitAnalyzer_HitForSim_test::~GEMHitAnalyzer_HitForSim_test(){}

auto GEMHitAnalyzer_HitForSim_test::track2vertex(const edm::Handle<edm::SimTrackContainer> gemSimTrack,
                                                auto trkid) {
...
auto GEMHitAnalyzer_HitForSim_test::vertex2parent(const edm::Handle<edm::SimVertexContainer> gemSimVertex,
                                                auto vertid) {
...
void
GEMHitAnalyzer_HitForSim_test::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  cout << "\n" << endl;
  /* GEM Geometry */
...
//  iSetup.get<MuonGeometryRecord>().get(hGEMGeom);
  ...
  for (const auto& simhit : *gemSimHits.product()) {
    ...
    cout << "pid: " << pid << ", prcs: " << process << endl;
...
void GEMHitAnalyzer_HitForSim_test::beginJob(){}
void GEMHitAnalyzer_HitForSim_test::endJob(){}

void GEMHitAnalyzer_HitForSim_test::beginRun(const edm::Run& run, const edm::EventSetup& iSetup) { 
  /* GEM Geometry */
  edm::ESHandle<GEMGeometry> hGEMGeom;
...
void GEMHitAnalyzer_HitForSim_test::endRun(edm::Run const&, edm::EventSetup const&){
}
                   
//define this as a plug-in
DEFINE_FWK_MODULE(GEMHitAnalyzer_HitForSim_test);