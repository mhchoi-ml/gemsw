    ...
    hGEMGeomBeginRun_(esConsumes<edm::Transition::BeginRun>())
{
  ...
  // muonToken_    = consumes<edm::View<reco::Muon> >(iConfig.getParameter<edm::InputTag>("muonLabel"));
...
//  hGEMGeom_ = esConsumes<GEMGeometry, MuonGeometryRecord>();
  ...
  // MuonBRANCH(muon_pt, F);
  // MuonBRANCH(muon_eta, F);
  // MuonBRANCH(muon_phi, F);
  // MuonBRANCH(muon_nMatchedStationLayer, I);
  // MuonBRANCH(muon_isTracker, I);
  // MuonBRANCH(muon_isGlobal, I);
  // MuonBRANCH(muon_isME0, I);
  // MuonBRANCH(muon_isLooseME0, I);
  // MuonBRANCH(muon_isTight, I); 
  // MuonBRANCH(muon_isMedium, I);
  // MuonBRANCH(muon_isLoose, I);
}
...
auto GEMHitAnalyzer_HitForSim::track2vertex(const edm::Handle<edm::SimTrackContainer> gemSimTrack,
                                                auto trkid) {
...
auto GEMHitAnalyzer_HitForSim::vertex2parent(const edm::Handle<edm::SimVertexContainer> gemSimVertex,
                                                auto vertid) {
...
// void GEMHitAnalyzer_HitForSim::initMuonValue() {
